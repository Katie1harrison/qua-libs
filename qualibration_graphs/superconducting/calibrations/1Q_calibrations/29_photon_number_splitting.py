...
node = QualibrationNode[Parameters, Quam](
    name="29_photon_number_splitting",
        ...
        for multiplexed_qubits in qubits.batch():
            ...
            with for_(n, 0, n < n_avg, n + 1):
                ...
                with for_(*from_array(df, dfs)):
                    # Thermalize (can be shortened when active_reset=True).
                    ...
                    # Reset qubit BEFORE displacing (qubit drives disturb cavity via χ).
                    ...
                    cavity_mode.cavity_mode_drive.play(
                        "displacement",
                        amplitude_scale=displacement_scale,
                    )
                    ...
                    # Since we know the displacement amplitude precisely, no
                    # calibration is needed — unlike the saturation approach.
