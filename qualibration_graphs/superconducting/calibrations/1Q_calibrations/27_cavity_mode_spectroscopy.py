...
node = QualibrationNode[Parameters, Quam](name="27_cavity_mode_spectroscopy", description=description, parameters=Parameters())
            ...
            with for_(n, 0, n < n_avg, n + 1):
                ...
                with for_(*from_array(f, dfs)):
                    for i, qubit in multiplexed_qubits.items():
                        # Thermalise qubit and cavity: use 5×T1 of the cavity mode.
